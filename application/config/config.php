...
|
*/
$config['base_url'] = 'http://localhost/mesprojets/ContexteCriee/'; //modifier par l'adresse du serveur ou local
...
$config['sess_save_path'] = sys_get_temp_dir(); // sinon on peut pas utiliser la redirection des messages se supprime  après une autre page ouverte
