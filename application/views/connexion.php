...
echo "<br>";
echo form_open('authentificationController/connexion', array('method' => 'post', 'id' => 'form-center'));
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/gsap.min.js"></script>
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="email" name = "mail" id="loginEmail" maxlength="254" />
        <p class="helper helper1">email@criee.com</p>
    </div>
    <div class="inputGroup inputGroup2">
        <label for="loginPassword" id="loginPasswordLabel">Mot de passe</label>
        <input type="password" name="mdp" id="loginPassword" />
